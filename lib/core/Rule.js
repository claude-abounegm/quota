...
class Rule {
    ...
    isAvailable(managerName, scope, resources, options, queuedRequest) {
        const scopeBundle = this.getBundleForScope(managerName, scope);
        ...
        return scopeBundle.throttling.isAvailable(this.getResourceAmount(resources), options);
    }
    ...
    reserve(managerName, scope, resources, options) {
        return this
            ...
            .throttling
            .reserve(this.getResourceAmount(resources), options);
    }
