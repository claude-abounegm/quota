...
class Rule {
    ...
    reportError(e) {
        for (const [, { throttling }] of _.toPairs(this._throttling)) {
            throttling.onError(this, e);
        }
    }
    ...
    enqueue(managerName, scope, resources, options, queuedRequest) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!queuedRequest) {
                ...
                queuedRequest = {
                    ...
                    abort: () => {
                        ...
                        this._getBundleForScope(scope).moreAvailable();
                    }
                };
            ...
            this._getBundleForScope(scope).queueing[queueingOp](queuedRequest);
        });
    }
