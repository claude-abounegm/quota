...
module.exports = function (options) {
    ...
    if (options.concurrentLimit !== false && !_.isNumber(options.concurrentLimit) && options.concurrentLimit <= 0) {
        throw new Error('options.concurrentLimit needs to be false or a number greater than 0');
    }
